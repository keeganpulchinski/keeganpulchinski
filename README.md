...
- 🔭 I’m currently working on a project that uses Ansible, Terraform, AWS, and local Cisco routers ↓↓↓↓↓ https://github.com/keeganpulchinski/Network-Automation-with-Cloud-Integration
